package codyhuh.wheezieswoods.common.blocks;
...
public class FlammableWoodLogBlock extends RotatedPillarBlock {
    public FlammableWoodLogBlock(Properties pProperties) {
        super(pProperties);
    }
